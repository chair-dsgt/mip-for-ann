...
class ConvBaselineModel(ConvModel):
    def __init__(self, name='ConvBaseline', input_size=-1 , n_output_classes=10, n_channels=1):
        ...
        super(ConvBaselineModel, self).__init__(conv_module_list, linear_module_list, first_linear_output, input_size, n_channels)
